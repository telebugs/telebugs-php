...
class ConfigTest extends TestCase
{
  ...
  public function testMiddleware(): void
  {
    ...
    $this->assertEquals(4, count($this->config->middleware()->getMiddlewares()));
  }
  ...
  public function testSetIgnoreEnvironments(): void
  {
    $this->config->setIgnoreEnvironments(["development", "staging"]);
    $this->assertEquals(["development", "staging"], $this->config->getIgnoreEnvironments());
  }
